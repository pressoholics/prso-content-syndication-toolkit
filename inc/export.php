 ...
 */
function prso_synd_toolkit_export_wp( $args = array() ) {
	global $wpdb, $post;
	...
	if ( $args['status'] && ( 'post' == $args['content'] || 'page' == $args['content'] || 'prso_synd_toolkit' == $args['content'] ) )
	...
	if ( 'post' == $args['content'] || 'page' == $args['content'] || 'prso_synd_toolkit' == $args['content'] ) {
		if ( $args['author'] )
...
<?php if ( $post_ids ) {
	global $wp_query, $pcst_exported_posts;
	...
	foreach ( $posts as $key => $post ) {
		...
		//Cache data for each post exported
		$pcst_exported_posts[ $post->post_type ][$key]['ID'] 			= $post->ID;
		$pcst_exported_posts[ $post->post_type ][$key]['post_content'] 	= $post->post_content;
