...
if ( !class_exists( "PrsoSyndToolkitOptions" ) ) {
	class PrsoSyndToolkitOptions {

		public $args = array();
		public $sections = array();
		public $theme;
		public $ReduxFramework;
		public $text_domain 	= PRSOSYNDTOOLKIT__DOMAIN;
		public $options_name 	= PRSOSYNDTOOLKIT__OPTIONS_NAME;
		...
		**/
			...
			$this->sections[] = array(
				...
				'fields' => array(
					array(
						...
						'subtitle' => __('Select post type.', $this->text_domain),
						'desc'     => __('Select post type you wish to syndicate.', $this->text_domain),
						// Must provide key => value pairs for select options
						'options'  => array(
						    'prso_synd_toolkit' => 'Syndication Posts',
						    'post' => 'Post (WP Blog Posts)',
						),
						'default'  => 'prso_synd_toolkit',
					)
				)
			);
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'display_name'			=> 'Content Syndication Toolkit (Master) Options', // Name that appears at the top of your panel
